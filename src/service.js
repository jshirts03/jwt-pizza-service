...
app.use(setAuthUser);
app.use(metrics.activeUserTracker);   //// THIS is HUGE;  uses the JWT service to encrypt the authorization token and adds a user field to the request that has the valid user taken from the database
